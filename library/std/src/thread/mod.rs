...
impl ThreadId {
    ...
    /// Returns the `ThreadId` for the [current thread][thread_current].
    ///
    /// This returns the same `ThreadId` that would be returned by a call to
    ...
    /// ```
    ///
    /// [thread_current]: crate::thread::current
    #[inline]
